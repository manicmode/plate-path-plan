-- Fix Arena function overload by removing defaults from 4-arg version
-- DROP existing overloads to avoid signature conflicts
...
-- 4-arg implementation (NO DEFAULTS) — create FIRST
CREATE FUNCTION public.arena_award_points(
  p_points numeric,
  p_kind   text,
  p_challenge_id uuid,
  p_idem_key text
