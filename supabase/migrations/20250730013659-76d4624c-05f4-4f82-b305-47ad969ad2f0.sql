-- Fix security issues by properly handling triggers and functions
...
DROP FUNCTION IF EXISTS public.enforce_single_active_routine() CASCADE;
DROP FUNCTION IF EXISTS public.get_user_active_routine(UUID) CASCADE;
DROP FUNCTION IF EXISTS public.activate_routine_safely(UUID, TEXT, UUID) CASCADE;
...
-- Recreate other functions with proper search_path
