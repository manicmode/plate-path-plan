...
DROP FUNCTION public.calculate_performance_score(INTEGER, INTEGER, INTEGER, INTEGER, INTEGER, TEXT);
DROP FUNCTION public.update_performance_score();
DROP TRIGGER trigger_update_performance_score ON public.workout_performance_logs;
