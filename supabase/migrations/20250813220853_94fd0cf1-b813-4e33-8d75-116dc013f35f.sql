-- Fix the _ensure_rank20_challenge function to include required description field
...
begin
  ...
  insert into public.private_challenges (title, description, creator_id, challenge_type, target_metric, target_value, duration_days, max_participants, status)
  values (
