-- Drop any existing arena_enroll_me functions and recreate the correct one
DROP FUNCTION IF EXISTS public.arena_enroll_me();
DROP FUNCTION IF EXISTS public.arena_enroll_me(uuid);
DROP FUNCTION IF EXISTS public.arena_enroll_me(text);

-- Recreate the V2 enrollment function
