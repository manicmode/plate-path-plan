-- Create voice action data tables with RLS
-- Hydration logs
...
CREATE INDEX IF NOT EXISTS idx_hydration_user_at ON public.hydration_logs (user_id, logged_at DESC);
CREATE INDEX IF NOT EXISTS idx_meal_user_at ON public.meal_logs (user_id, logged_at DESC);
CREATE INDEX IF NOT EXISTS idx_workout_user_at ON public.workout_logs (user_id, logged_at DESC);