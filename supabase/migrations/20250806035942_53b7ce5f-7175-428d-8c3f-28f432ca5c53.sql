-- Security Cleanup Migration (Fixed Order)
...
-- 4. Update security functions with proper search_path
...
-- 5. RLS Policies for security_events
...
-- 6. RLS Policies for security_violations
...
-- 7. Drop and recreate SECURITY DEFINER views as RLS-compatible
