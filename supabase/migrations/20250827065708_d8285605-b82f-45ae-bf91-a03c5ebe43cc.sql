-- Create nudge monitoring views with proper numeric casting

-- Daily metrics (last 30 days)
CREATE OR REPLACE VIEW public.v_nudge_daily_metrics AS
WITH base AS (
  SELECT
...
-- Weekly overview (last 12 weeks)
CREATE OR REPLACE VIEW public.v_nudge_weekly_overview AS
WITH base AS (
  SELECT
