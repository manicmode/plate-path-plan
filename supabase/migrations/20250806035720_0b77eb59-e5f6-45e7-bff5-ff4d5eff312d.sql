-- Security Cleanup Migration (Fixed)
-- Note: pg_net extension cannot be moved to another schema, so we'll skip that step

-- 1. Update security functions with proper search_path
...
-- 2. Create severity_level enum if it doesn't exist
DO $$ BEGIN
