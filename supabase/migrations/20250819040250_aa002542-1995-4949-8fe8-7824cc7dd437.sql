-- Complete fix for habit reminder dispatch with proper conflict handling

-- Add the scheduled_date column
ALTER TABLE public.habit_nudges 
ADD COLUMN scheduled_date date NOT NULL GENERATED ALWAYS AS (scheduled_for::date) STORED;
