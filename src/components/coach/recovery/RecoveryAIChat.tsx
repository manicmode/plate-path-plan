    ...
    <Card className="glass-card border-0 rounded-3xl">
      <CardHeader className={`${isMobile ? 'pb-3' : 'pb-4'}`}>
        <CardTitle className={`flex items-center space-x-2 ${isMobile ? 'text-base' : 'text-lg'}`}>
          ...
          <span>Recovery Coach Chat</span>
        </CardTitle>
      </CardHeader>
      <CardContent className={`${isMobile ? 'p-4' : 'p-6'} pt-0`}>
        {/* Messages Container */}
        <div className={`${isMobile ? 'h-[400px]' : 'h-[500px]'} flex flex-col`}>
                  ...
                  >
                    ...
                    <div
                      className={`flex-1 p-3 rounded-2xl break-words ${
                        message.isUser
                          ? 'bg-blue-600 text-white max-w-[80%] ml-auto'
        ...
        <div className={`flex space-x-2 mt-4`}>
          <Input
            ...
            placeholder="Ask me about recovery, mindfulness, or wellness..."
            disabled={isLoading}
