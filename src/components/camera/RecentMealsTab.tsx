...
interface RecentMealsTabProps {
  onFoodSelect: (food: any) => void;
  onBarcodeSelect: (barcode: string) => void;
}

export const RecentMealsTab = ({ onFoodSelect, onBarcodeSelect }: RecentMealsTabProps) => {
  ...
  if (todaysFoods.length === 0 && recentBarcodesLimited.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-semibold mb-2">No Recent Meals</h3>
