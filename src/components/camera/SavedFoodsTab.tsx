...
import { Clock, Repeat, AlertCircle, Brain, TrendingUp, ChevronDown } from 'lucide-react';
...
export const SavedFoodsTab = ({ onFoodSelect, onRefetch }: SavedFoodsTabProps) => {
      ...
      if (!nutritionData || nutritionData.length === 0) {
        ...
        if (currentHour < 11) {
          return [
            ...
            { food_name: 'Fresh Fruit Bowl', calories: 100, usual_time: 'morning', frequency: 1 },
            { food_name: 'Coffee with Milk', calories: 50, usual_time: 'morning', frequency: 1 }
          ];
          ...
          return [
            ...
            { food_name: 'Caesar Salad', calories: 220, usual_time: 'afternoon', frequency: 1 },
            { food_name: 'Wrap with Hummus', calories: 180, usual_time: 'afternoon', frequency: 1 }
          ];
        } else {
          return [
            ...
            { food_name: 'Pasta with Marinara', calories: 280, usual_time: 'evening', frequency: 1 },
            { food_name: 'Grilled Tofu', calories: 160, usual_time: 'evening', frequency: 1 }
          ];
        }
      }
  ...
  // Render AI Quick Predictions + saved foods list
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className={`flex items-center ${isMobile ? 'space-x-3 mb-4' : 'space-x-4 mb-6'}`}>
          <div className={`${isMobile ? 'w-10 h-10' : 'w-12 h-12'} bg-gradient-to-br from-emerald-500 to-blue-500 rounded-full flex items-center justify-center shadow-lg`}>
          ...
          <div className="space-y-3 mt-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Saved Foods</h4>
                {debugMode && (
