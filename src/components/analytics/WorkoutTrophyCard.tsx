...
export const WorkoutTrophyCard = ({ className, showFullStats = true }: WorkoutTrophyCardProps) => {
  ...
  return (
    <Card className={`relative overflow-hidden dark:bg-gradient-to-br ${awardConfig.bgColor} ${awardConfig.borderColor} dark:!border-2 dark:!border-indigo-500/60 dark:bg-gradient-to-r dark:from-indigo-500/30 dark:to-purple-500/30 ${className}`}>
      <CardHeader className="pb-4">
