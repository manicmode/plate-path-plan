    ...
    <Card className="mb-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm">
      <Collapsible open={isDailyAveragesOpen} onOpenChange={setIsDailyAveragesOpen}>
        <CollapsibleTrigger asChild>
          <div className="flex items-center gap-3 p-4 cursor-pointer group hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-200 rounded-lg">
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Daily Averages</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Click to view your weekly performance overview</p>
            </div>
