        ...
        <CardContent className={`${isMobile ? 'p-4' : 'p-6'} pt-0`}>
          <Tabs value={currentTab} onValueChange={(value) => {
            ...
            <TabsList className="grid w-full grid-cols-2 glass-button border-0">
              <TabsTrigger value="login" className="data-[state=active]:gradient-primary data-[state=active]:text-white dark:data-[state=active]:bg-gray-800 dark:data-[state=active]:text-white">
                Sign In
              </TabsTrigger>
              <TabsTrigger value="register" className="data-[state=active]:gradient-primary data-[state=active]:text-white dark:data-[state=active]:bg-gray-800 dark:data-[state=active]:text-white">
                Sign Up
              </TabsTrigger>
            </TabsList>
