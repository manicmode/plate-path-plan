                        ...
                        <div className="flex justify-end mt-3">
                          <Button
                            onClick={(e) => {
                              e.stopPropagation();
                              if (supplement.slug) {
                                navigate(`/supplements/${supplement.slug}`, { state: { from: 'hub' } });
                              } else {
                                toast({
                                  title: "Coming Soon",
                            ...
                            className={`glass-button ${isMobile ? 'h-8 text-xs px-3' : 'h-10 text-sm px-4'} rounded-xl hover:scale-105 transition-transform duration-200`}
                          >
                            View Details
                          </Button>
                        </div>
