...
const Home = () => {
  ...
  return (
    <div className="space-y-10 animate-fade-in">
      ...
      {/* AI Insights Card - More space from bottom menu */}
      <Card className="visible-card border-0 rounded-3xl animate-slide-up float-animation mb-80" style={{ animationDelay: '600ms' }}>
        <CardContent className="p-8">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 text-white px-10 py-5 rounded-2xl font-bold text-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 neon-glow"
            >
              Ask your AI coach ✨ →
            </Button>
          </div>
