              ...
              <div className={`grid grid-cols-2 ${isMobile ? 'gap-6 max-w-sm' : 'gap-8 max-w-4xl'} w-full`}>
                {toxinData.map((item, index) => {
                  ...
                  return (
                    <Card
                      key={item.name}
                      className={`modern-nutrient-card border-0 rounded-3xl animate-slide-up hover:scale-105 transition-all duration-500 shadow-lg hover:shadow-xl w-full ${
                        isOverThreshold 
                      ...
                      style={{ animationDelay: `${index * 100}ms` }}
                    >
                      <CardContent className={`${isMobile ? 'p-4' : 'p-6'} flex flex-col text-center space-y-3`}>
                        {/* Icon and Title */}
                        <div className="flex flex-col items-center">
                          ...
                          <h4 className={`font-bold text-gray-900 dark:text-white ${isMobile ? 'text-sm' : 'text-base'}`}>
                            {item.name}
                          </h4>
                        </div>
