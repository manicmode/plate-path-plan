    ...
    <div className="space-y-12 sm:space-y-16 animate-fade-in">
      ...
      <div className="text-center space-y-6 sm:space-y-8 py-6 sm:py-8">
        <div className="inline-block">
          <h1 className={`${isMobile ? 'text-3xl' : 'text-5xl'} font-bold bg-gradient-to-r from-gray-900 via-emerald-600 to-blue-600 dark:from-gray-100 dark:via-emerald-400 dark:to-blue-400 bg-clip-text text-transparent mb-4 relative fade-up-stagger motion-reduce:animate-none`}>
            <span className="word-1">Let's</span>
            <span className="word-2"> optimize</span>
            <span className="word-3"> your</span>
            <span className="word-4"> day,</span>
          </h1>
