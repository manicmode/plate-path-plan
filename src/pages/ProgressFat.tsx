...
const ProgressFat = () => {
  ...
  const dailyData = [
    { name: 'Mon', value: 60, target: targetFat },
    { name: 'Tue', value: 70, target: targetFat },
    { name: 'Wed', value: 65, target: targetFat },
    { name: 'Thu', value: 75, target: targetFat },
    { name: 'Fri', value: 58, target: targetFat },
    { name: 'Sat', value: 68, target: targetFat },
    { name: 'Today', value: Math.round(todayProgress.fat), target: targetFat },
  ];

  const weeklyData = [
    { name: 'Week 1', value: 62, target: targetFat },
    { name: 'Week 2', value: 68, target: targetFat },
    { name: 'Week 3', value: 64, target: targetFat },
    { name: 'Week 4', value: 66, target: targetFat },
  ];

  const monthlyData = [
    { name: 'Jan', value: 63, target: targetFat },
    { name: 'Feb', value: 67, target: targetFat },
    { name: 'Mar', value: 69, target: targetFat },
  ];
  ...
  const getGoalPercentage = () => {
    ...
    return Math.round((average / targetFat) * 100);
  };
    ...
    if (active && payload && payload.length) {
      return (
        <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow-lg border">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">{`Target: ${targetFat}g`}</p>
        </div>
      );
    }
    return null;
    ...
    <div className="space-y-6 animate-fade-in pb-8">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 bg-gradient-to-r from-purple-400 to-violet-600 rounded-xl flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">Track your fat intake over time</p>
          </div>
        </div>
      </div>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">{targetFat}</p>
      ...
      <Card className="visible-card shadow-lg">
        <CardHeader>
          <CardTitle className="text-center text-gray-900 dark:text-white">
            {viewMode.charAt(0).toUpperCase() + viewMode.slice(1)} Fat Intake
          </CardTitle>
        </CardHeader>
        <CardContent>
